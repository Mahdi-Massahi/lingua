...
<main class="container mx-auto px-4 py-8 flex-1 overflow-y-auto">
	<header class="mb-8">
	...
	<!-- Vocabulary -->
	<section class="bg-gray-900 border border-white/5 rounded-2xl p-6 shiny-border shadow-xl">
						...
						<tr class="hover:bg-white/5 transition-colors group">
							<td class="px-6 py-4 font-medium text-gray-100">
								<div class="flex items-center gap-3">
									<button onclick={() => speak(item.text)} class="text-violet-400 hover:text-white hover:bg-violet-600 p-1.5 rounded-full transition-all" title="Play">
									...
									<button
										...
										class="{item.starred ? 'text-yellow-400' : 'text-gray-600 group-hover:text-gray-400'} p-1.5 rounded-lg hover:bg-white/10 transition-colors"
									>
							...
							<td class="px-6 py-4 text-gray-300">{item.translation || '-'}</td>
							<td class="px-6 py-4">
